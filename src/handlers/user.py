...
async def start(message: Message):
    ...
    await message.answer(
        ...
        "🔎 <b>רוצים לראות כרטיסים שכבר פורסמו?</b>\n"
        "לחצו על <b>אירועים זמינים</b> → בחרו אירוע → <b>צפייה בכרטיסים זמינים</b>\n\n"
        "🗑 <b>מכרתם כרטיס?</b> לחצו על כפתור <b>מחיקת כרטיס</b> שמופיע "
        "אחרי הפרסום כדי להסיר אותו ולעדכן את כל הרשומים.\n\n"
...
async def help_command(message: Message):
    ...
    await message.answer(
        ...
        "אחרי הפרסום כדי להסיר אותו ולעדכן את כל הרשומים.\n\n"
        "💡 <b>איך זה עובד?</b>\n"
        "1. לחצו על <b>אירועים זמינים</b> ובחרו אירוע\n"
        "2. הירשמו לקבלת התראות\n"
        "3. כשמישהו מפרסם כרטיס — תקבלו הודעה ישירות לכאן עם כל הפרטים!\n\n"
