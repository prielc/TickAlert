...
async def help_command(message: Message):
    ...
    await message.answer(
        "📖 <b>עזרה — TickAlert</b>\n\n"
        "לא צריך לחפש כרטיסים — קבלו התראה ברגע שכרטיס מתפנה!\n\n"
        "🎫 <b>אירועים זמינים</b> — הצגת כל האירועים הפעילים\n"
        "📋 <b>האירועים שלי</b> — האירועים שנרשמת אליהם\n"
        "💰 <b>פרסום כרטיס למכירה</b> — פרסום כרטיס למכירה\n"
        "❌ <b>ביטול</b> — ביטול פעולה נוכחית\n\n"
        "💡 <b>איך זה עובד?</b>\n"
        "1. לחצו על <b>אירועים זמינים</b> ובחרו אירוע\n"
        "2. הירשמו לקבלת התראות\n"
        "3. כשמישהו מפרסם כרטיס — תקבלו הודעה מיידית!",
    )
